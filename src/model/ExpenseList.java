...
public class ExpenseList implements Serializable
{
	...
	public double getCostPerMonthOfAllExpenses()
	{
		...
		//This is an example of polymorphism. From the pov of this for loop it only cares that there is 
		// a list of Expense objects and that each on can send back its monthly cost.
